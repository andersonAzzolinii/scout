...
import { SVG_ASPECT_RATIO, FIXED_POSITIONS } from '@/constants/campo.constants';
import type { PlayerPosition } from '@/types/futsal.types';
import type { MatchEvent } from '@/types';

interface CampoCourtProps {
  width: number;
...
/**
 * Main campo court component with SVG rendering and position buttons (11 players)
 */
export function CampoCourt({
  width,
  positionedPlayers = [],
  onPositionPress,
  onPlayerPress,
